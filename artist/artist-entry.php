...
<div class="sidebar">
	...
	<section class="home-section">
		...
		<div class="home-content">
			<h3>Tambahkan Data Seniman</h3>
			<div class="form-login">
			<form action="artist-proses.php" method="post" enctype="multipart/form-data">
					<label for="judul">Nama</label>
					<input class="input" type="text" name="nama" id="categories" placeholder="Nama" />
					<label for="categories">Tempat, Tanggal Lahir</label>
					<input class="input" type="text" name="ttl" id="price" placeholder="Tempat. Tanggal Lahir" />
					<label for="categories">Email</label>
					<input class="input" type="text" name="email" id="Description" placeholder="Email" />
